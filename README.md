...
![Created GUI](https://github.com/rscobie/ECE_573_FINAL_PROJECT/blob/main/Screenshot from 2021-04-29 15-55-42.png)
Format: ![Alt Text](url)
...
![World Chunk and Vehicle](https://github.com/rscobie/ECE_573_FINAL_PROJECT/blob/main/Screenshot from 2021-04-29 16-02-16.png)
Format: ![Alt Text](url)

* A new window should also have opened up. This allows control of the vehicle using rqt steering as seen below:

![RQT Steering GUI](https://github.com/rscobie/ECE_573_FINAL_PROJECT/blob/main/Screenshot from 2021-04-29 16-02-30.png)
Format: ![Alt Text](url)
...
![GPS Commands](https://github.com/rscobie/ECE_573_FINAL_PROJECT/blob/main/Screenshot from 2021-04-29 16-04-34.png)
Format: ![Alt Text](url)
